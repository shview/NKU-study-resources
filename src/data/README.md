...
Each manifest course requires an immutable UUID `uid`; the legacy `id` remains the website route key. Use the reviewed migration command described in `docs/data-schema.md`, never an ad-hoc text replacement.
